...
Árvores básicas: se σ ∈ T , X ∈ V e X → glyph[epsilon1] é uma regra de G , então

<!-- image -->

são árvores gramaticais e suas colheitas são, respectivamente, σ e glyph[epsilon1] .
...
Segue também da definição que os únicos vértices de uma árvore gramatical que podem ser rotulados por elementos de T ∪ { glyph[epsilon1] } são as folhas. Portanto, um vértice interior de uma árvore gramatical só pode ser rotulado por uma variável.
...
Precisamos considerar, separadamente, o efeito desta construção quando T é a árvore básica que tem a raiz rotulada pela variável X e uma única folha rotulada por glyph[epsilon1] . Neste caso, quando removemos a raiz sobra apenas um vértice rotulado por glyph[epsilon1] , que não constitui uma árvore gramatical. Suporemos, então, que remover a raiz de uma tal árvore tem o efeito de apagar toda a árvore.
...
Só nos resta mostrar que vy = glyph[epsilon1] . Mas se vy fosse igual a glyph[epsilon1] então a árvore T 0 , construída no parágrafo anterior, teria colheita igual a w , e menos folhas que T , o que contradiz a hipótese 1. Portanto, vy = glyph[epsilon1] e provamos (1), concluindo assim a demonstração do lema do bombeamento.
